...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Game.date_started'
        db.add_column('game_game', 'date_started',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 3, 24, 0, 0)),
                      keep_default=False)

        # Adding field 'Haiku.date_played'
        db.add_column('game_haiku', 'date_played',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 3, 24, 0, 0)),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Game.date_started'
        db.delete_column('game_game', 'date_started')

        # Deleting field 'Haiku.date_played'
        db.delete_column('game_haiku', 'date_played')
    ...
    models = {
        ...
        'game.haiku': {
            'Meta': {'ordering': "['?']", 'unique_together': "[('player', 'turn')]", 'object_name': 'Haiku'},
